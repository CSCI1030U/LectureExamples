...
def dc_search(values, to_find):
    ...
    a_answer = dc_search(a, to_find)
    b_answer = dc_search(b, to_find)

    # combine
    return a_answer or b_answer


print(f'{dc_search([3,5,1,4,2], 1) = }')
print(f'{dc_search([3,5,1,4,2], 2) = }')
print(f'{dc_search([3,5,1,4,2], 3) = }')
print(f'{dc_search([3,5,1,4,2], 4) = }')
print(f'{dc_search([3,5,1,4,2], 5) = }')
print(f'{dc_search([3,5,1,4,2], 9) = }')
